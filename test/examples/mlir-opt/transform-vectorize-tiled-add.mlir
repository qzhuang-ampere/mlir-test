// RUN: kestrel-opt %s --transform-interpreter --split-input-file -canonicalize -cse | FileCheck %s
...
module {
  ...
  module attributes {transform.with_named_sequence} {
    transform.named_sequence @__transform_main(%arg1: !transform.any_op {transform.readonly}) {
      ...
      %tiled_op, %forall_op = transform.structured.tile_using_forall %0 num_threads [4096, 64]
